    ...
    <main class="main-content">
        <div class="verify-form-panel">
            <div class="text-center mb-4">
                <i class="bi bi-envelope-check" style="font-size: 4rem; color: var(--accent-pink);"></i>
            ...
            <div class="info-box">
                <p class="mb-0" style="color: #666; font-size: 14px;">
                    ...
                    Mã OTP đã được gửi đến email của bạn. Vui lòng nhập mã 6 chữ số để kích hoạt tài khoản.
                </p>
            </div>

            <form id="otpForm" action="<c:url value='/verify-otp'/>" method="post">
            ...
            <div class="text-center">
                ...
                <p style="color: #666; font-size: 14px;">
                    Chưa nhận được mã?
                    <a href="#" id="resendLink" class="resend-link" onclick="resendOtp(event)">
    ...
    <script>
        ...
        function resendOtp(event) {
            ...
            if (confirm('Bạn có muốn gửi lại mã OTP?')) {
                ...
                form.method = 'POST';
                form.action = '<c:url value="/resend-otp"/>';
