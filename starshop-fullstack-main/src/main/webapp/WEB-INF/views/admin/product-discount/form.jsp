...
<head>
    ...
    <%-- Copied styles from promotion/form.jsp for consistent UI --%>
    <style>
        :root {
            --accent-pink: #FFB6C1;
            --text-dark: #343a40;
    ...
    <div class="container">
        ...
        <div class="checkout-panel">
            <div class="section-title">
                ...
                <a href="<c:url value='/admin/product-discount'/>" class="btn btn-outline-secondary">
                    <i class="fas fa-arrow-left"></i> Quay lại danh sách
                </a>
            </div>

            <form:form action="/admin/product-discount/save" method="post" modelAttribute="discount">
                <form:hidden path="id"/>
                    ...
                    <select name="productId" id="productId" class="form-select" required>
                        ...
                        <c:forEach var="product" items="${products}">
                            <option value="${product.id}"
                                    ${discount.product != null && discount.product.id == product.id ? 'selected' : ''}>
                                ${product.name} - ${product.shop.name}
                            </option>
                        </c:forEach>
                    </select>
                    <div class="form-text">Chọn sản phẩm cần áp dụng giảm giá.</div>
                </div>

                <div class="mb-3">
                    <label for="discountPercentage" class="form-label">Phần Trăm Giảm Giá (%) <span class="text-danger">*</span></label>
                    <form:input path="discountPercentage" id="discountPercentage" type="number"
                                cssClass="form-control" required="true" min="1" max="100"
                                placeholder="VD: 20"/>
                ...
                <div class="form-check form-switch mb-4">
                    ...
                    <label class="form-check-label" for="active">
                        <strong>Kích hoạt giảm giá</strong>
                    </label>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<c:url value='/admin/product-discount'/>" class="btn btn-secondary">
