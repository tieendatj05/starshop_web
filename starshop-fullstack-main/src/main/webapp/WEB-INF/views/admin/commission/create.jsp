...
<head>
    ...
    <title>Tạo Chiết Khấu Mới - Admin</title>
...
<main class="main-content py-5">
    <div class="container">
        ...
        <div class="checkout-panel">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/commissions/create">
                <div class="mb-3">
                    <label for="shopId" class="form-label">Chọn Shop <span class="text-danger">*</span></label>
                    <select class="form-select" id="shopId" name="shopId" required>
                        <option value="">-- Vui lòng chọn một shop --</option>
                ...
                <div class="mb-4">
                    <label for="percentage" class="form-label">Tỷ lệ chiết khấu (%) <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" id="percentage" name="percentage"
                           min="0" max="100" step="0.01" required placeholder="Ví dụ: 5.5">
                    <div class="form-text">Nhập tỷ lệ phần trăm chiết khấu cho shop trong kỳ đã chọn.</div>
                </div>

                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-themed">
                        <i class="fas fa-save"></i> Tạo Chiết khấu
                    </button>
                    <a href="<c:url value='/admin/commissions'/>" class="btn btn-secondary">
