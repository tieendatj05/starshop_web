...
<head>
    ...
    <title>Chỉnh Sửa Thông Tin - StarShop</title>
            ...
            <form:form action="/profile/update" method="post" modelAttribute="user">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <form:input path="fullName" id="fullName" cssClass="form-control" placeholder="Nhập họ và tên"/>
                    </div>

                    <div class="col-md-6">
                        <label for="phoneNumber" class="form-label">Số điện thoại</label>
                        <form:input path="phoneNumber" id="phoneNumber" cssClass="form-control" placeholder="Nhập số điện thoại"/>
                    </div>

                    <div class="col-12">
                        <label for="email" class="form-label">Email</label>
                        <form:input path="email" id="email" type="email" cssClass="form-control" placeholder="Nhập email"/>
                    </div>

                    <div class="col-12 mt-4 d-flex justify-content-end gap-2">
                        <a href="<c:url value='/profile'/>" class="btn btn-secondary">Hủy</a>
